...
BARRIER = tex_coords((1, 2), (1, 2), (1, 2))
DIRT = tex_coords((0, 1), (0, 1), (0, 1))
COBBLESTONE = tex_coords((2, 2), (2, 2), (2, 2))
PLANKS = tex_coords((3, 2), (3, 2), (3, 2))
...
class Window(pyglet.window.Window):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.inventory = [BRICK, GRASS, SAND, WOOD, LEAF, STONE, DIRT, COBBLESTONE, PLANKS]
...
def main():
    window = Window(width=1280, height=720, caption=f'Minecraft - Python Edition {version}', resizable=True)
